  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      <div className="flex items-center justify-between space-y-2">
        <h2 className="text-3xl font-bold tracking-tight">Mutual Fund Investments</h2>
        <p className="text-muted-foreground">
          Track your mutual fund portfolio and professionally managed investments
        </p>
      </div>
      <Suspense fallback={<InvestmentsByTypeSkeleton />}>
        <InvestmentsByType type="mutual_funds" />
      </Suspense>
    </div>
  );
}