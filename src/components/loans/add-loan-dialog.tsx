...
export function AddLoanDialog({
  ...
  // Auto-calculating currency is disabled
  ...
  // Calculate monthly payment based on loan parameters (manual trigger)
        ...
        <DialogContent className="sm:max-w-[800px] max-h-[90vh] px-2">
          <div className="flex flex-col max-h-[80vh] overflow-y-auto px-4 my-8  "> 
            ...
            <DialogHeader>
              ...
              <DialogDescription>
                Add a loan to track your debt and payment schedule. We&apos;ll
                help you understand the impact on your finances and any currency
                risks.
              </DialogDescription>
            </DialogHeader>

          {/* Currency risk auto-detection disabled */}
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="flex items-center justify-between">
                          ...
                          <span className="text-sm text-muted-foreground">
                            {Math.round((field.value / 12) * 10) / 10} years (
                            {field.value} months)
                          </span>
                        </FormLabel>
                        <FormControl>
              ...
              <div className="space-y-3">
                ...
                <div className="p-4 rounded-lg border bg-background">
                  <div className="flex items-center justify-between mb-4">
                    <div className="text-sm text-muted-foreground">
                      Payment automatically calculates as you enter loan details
                    </div>
                    <Button
                      type="button"
                      variant="outline"
